...
module.exports = "<form [formGroup]=\"loginForm\" class=\"loginForm\" (ngSubmit)=\"login()\">\n  <div class=\"row\">\n    <div class=\"col-sm-4\"></div>\n    <div class=\"col-sm-4\">\n        <div class=\"alert alert-danger\" role=\"alert\" *ngIf=\"invalidLogin\">\n            Username/Password invalid. Please try again\n          </div>\n      <div class=\"form-group\">\n        <label for=\"exampleInputEmail1\">Email address</label>\n        <input formControlName=\"email\" type=\"email\" class=\"form-control\" aria-describedby=\"emailHelp\" placeholder=\"Enter email\">\n        <div *ngIf=\"loginForm.controls['email'].touched && loginForm.controls['email'].invalid\">\n          <div *ngIf=\"loginForm.controls['email'].hasError('required')\" class=\"err-msg\">{{appConst.VALIDATION_MSG.EMAIL_REUIRED}}</div>\n          <div *ngIf=\"loginForm.controls['email'].hasError('email') || loginForm.controls['email'].hasError('pattern')\" class=\"err-msg\">*Enter valid email</div>\n        </div>\n      </div>\n      <div class=\"form-group\">\n        <label for=\"exampleInputPassword1\">Password</label>\n        <input formControlName=\"password\" type=\"password\" class=\"form-control\" placeholder=\"Password\">\n        <div *ngIf=\"loginForm.controls['password'].touched && loginForm.controls['password'].invalid\">\n          <div *ngIf=\"loginForm.controls['password'].hasError('required')\">\n            <p [ngStyle]=\"{'color' : 'red'}\">*Password field is required</p>\n          </div>\n          <div *ngIf=\"loginForm.controls['password'].hasError('minlength')\">\n            <p class=\"err-msg\">*Password must be at least 8 characters long</p>\n          </div>\n        </div>\n      </div>\n      <button type=\"submit\" class=\"btn btn-primary\" [disabled]=\"!loginForm.valid\">Submit</button>\n    </div>\n    <div class=\"col-sm-4\"></div>\n  </div>\n</form>\n"

/***/ }),

/***/ "./src/app/config/app.const.ts":
/*!*************************************!*\
  !*** ./src/app/config/app.const.ts ***!
  \*************************************/
/*! exports provided: APP_CONST */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "APP_CONST", function() { return APP_CONST; });
var APP_CONST = {
    HEADERS: {
    ...
    VALIDATION_MSG: {
        EMAIL_REUIRED: '*Email field is required',
        PASSWORD_REQUIRED: ''
    }
};
...
module.exports = ".loginForm {\n  margin: 13%;\n}\n\n.err-msg {\n  color: red;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var src_app_config_app_const__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/config/app.const */ "./src/app/config/app.const.ts");
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(fb, commonService, auth, router) {
        this.fb = fb;
        this.commonService = commonService;
        this.auth = auth;
        this.router = router;
        this.appConst = src_app_config_app_const__WEBPACK_IMPORTED_MODULE_6__["APP_CONST"];
    }
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.commonService.checkLoginStatus(loginData).subscribe(function (response) {
            if (response.status) {
...
var routes = [
    { path: '', pathMatch: 'full', component: _components_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"] }
];
...
/* harmony import */ var _components_login_login_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/login/login.component */ "./src/app/login/components/login/login.component.ts");
...
var CommonService = /** @class */ (function () {
    ...
    CommonService.prototype.checkLoginStatus = function (myRequest) {
        ...
        return this.http.post('http://localhost/angularProject/myApp/services/login.php', myRequest, httpOptions);
    };
