...
module.exports = " <!-- Fixed navbar -->\n <nav class=\"navbar navbar-expand-md navbar-dark fixed-top bg-primary\">\n    <div class=\"collapse navbar-collapse\" id=\"navbarCollapse\">\n      <ul class=\"navbar-nav mr-auto\">\n        <li class=\"nav-item active\">\n          <a href=\"javascript:void(0)\" class=\"nav-link\" (click)=\"menuRedirection('login')\">Login</a>\n        </li>\n        <li class=\"nav-item active\">\n          <a href=\"javascript:void(0)\" class=\"nav-link\" (click)=\"menuRedirection('home')\">Form</a>\n        </li>\n        <li class=\"nav-item active\">\n          <a href=\"javascript:void(0)\" class=\"nav-link\" (click)=\"menuRedirection('list')\">List</a>\n        </li>\n        <li *ngIf = \"auth.loggedIn\" class=\"nav-item active\">\n          <a href=\"javascript:void(0)\" class=\"nav-link\" (click)=\"logOut()\">Logout</a>\n        </li>\n      </ul>\n    </div>\n  </nav>\n"
...
var routes = [
    ...
    {
        path: 'home',
        loadChildren: function () { return __webpack_require__.e(/*! import() | request-form-request-form-module */ "request-form-request-form-module").then(__webpack_require__.bind(null, /*! ./request-form/request-form.module */ "./src/app/request-form/request-form.module.ts")).then(function (m) { return m.RequestFormModule; }); },
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.menuRedirection = function (menuName) {
...
var LoginGuard = /** @class */ (function () {
    ...
    LoginGuard.prototype.canActivate = function (next, state) {
        ...
        //   return false;
        // }
        var access = this.auth.isAuthenticated();
...
module.exports = __webpack_require__(/*! /var/www/html/angularProject/myApp/src/main.ts */"./src/main.ts");
